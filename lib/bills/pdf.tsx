...
const styles = StyleSheet.create({
  ...
  rule: { borderBottomWidth: 1, borderBottomColor: COLORS.taupeLt, marginVertical: 12 },
  ...
  tableHead: {
    ...
    backgroundColor: COLORS.cream,
    borderBottomWidth: 1,
    borderBottomColor: COLORS.taupeLt,
    paddingVertical: 6,
    paddingHorizontal: 4,
  },
  /**
  ...
  grandRow: {
    ...
    paddingVertical: 7,
    paddingHorizontal: 8,
    backgroundColor: COLORS.taupeLt,
    borderRadius: 4,
  },
